# ASD-STE100 Simplified Technical English — Dictionary (Part 2, condensed)

Source: ASD-STE100 Simplified Technical English, Issue 9 (2025-01-15), (c) ASD.
Condensed for AI/model context use: one line per dictionary entry, illustrative
STE/non-STE example sentences and regular verb-conjugation forms removed. For the
full writing rules, see STE-writing-rules.md in this folder.

Format:
  WORD (part-of-speech): meaning              <- word in UPPERCASE = approved in STE; use it.
  word (part-of-speech): ALTERNATIVE (pos)     <- word in lowercase = NOT approved; use the alternative(s) shown instead.
Multiple meanings/alternatives for one entry are separated by "; ".
(TN) = technical noun, (TV) = technical verb (referenced as alternatives; not
separately defined here). Entries are in source alphabetical order.
...
accommodate (v): LET (v)
accomplish (v): DO (v) You can use a more accurate verb.; COMPLETE (v)
...
adverse (adj): BAD (adj); If it is possible, give accurate and correct conditions.
advisable (adj): RECOMMEND (v)
advise (v): TELL (v); RECOMMEND (v)
affect (v): EFFECT (n); If it is possible, be accurate.
...
annunciate (v): SHOW (v)
another (adj): ONE (TN) MORE; DIFFERENT (adj); AGAIN (adv); COUNTERCLOCKWISE; (adv)
...
ARM (v): 1. To install armaments; 2. To prepare for automatic operation
AROUND (prep): On all sides of | other meanings: APPROXIMATELY (adv)
arrange (v): PUT (v)
...
BELOW (prep): In (or to) a position farther down than something; | other meanings: LESS THAN
...
big (adj): LARGE (adj) If it is possible, give an accurate value.
...
build (v): ASSEMBLE (v)
bump (v): HIT (v)
BURN (v): 1. To cause or undergo combustion; 2. To cause injury or damage through heat
burst (v): BREAK (v)
...
CANCEL (v): 1. To do the necessary steps to stop a process; 2. To remove the validity of something
...
carry out (v): DO (v); You can use a more accurate command verb.; MEASURE (v)
case (n): CONDITION (n)
...
CLEAR (adj): 1. Without blockage or interference; 2. Easy to understand and without ambiguity | other meanings: TRANSPARENT (adj)
...
close (adj): NEAR (prep)
CLOSE (v): 1. To move together, or to move to a position that stops or prevents materials from going in or out; 2. To operate a circuit breaker to make an electrical circuit
...
comply (v): OBEY (v); Used in law and regulations. Refer to rule 1.12.
COMPONENT (n): A part, subassembly, or unit that has a specified function
comprehensive (adj): FULL (adj)
COMPRESS (v): To decrease or cause to decrease in dimension or volume
...
consult (v): REFER (v)
CONTACT (v): To start communication; | other meanings: TOUCH (v)
...
COUNT (v): To add the number of objects or occurrences to get a total
COUNTERCLOCK- WISE (adv): In the opposite direction to clockwise
...
CUT (v): 1. To divide into parts; 2. To remove with a sharp tool
...
danger (n): RISK (n); DANGEROUS (adj) “danger” is a technical noun when it identifies a safety instruction. Refer to section 7.
...
DEACTIVATE (v): To make a system, function, or feature no longer ready for operation | other meanings: STOP (v)
deadly (adj): KILL (v)
...
DIRTY (adj): Not clean
disappear (v): VIEW (n)
DISARM (v): 1. To remove armaments; 2. To prevent automatic operation
...
ELECTROMAG- NETIC (adj): Related to electromagnetism
ELECTROMAG- NETICALLY (adv): Related to electromagnetism
...
exceed (v): MORE THAN
except (prep): To replace this word, use a different construction. Be accurate.
exception (n): To replace this word, use a different construction. Be accurate.
...
facility (n): Be accurate. Use the name of the facility as a technical noun.
...
failure (n): IF … NOT; This word when it means a performance error or loss of serviceability is a technical noun.
...
familiar (adj): KNOW (v)
FAR (adj): At or to a relatively large distance
...
few (adj): SMALL NUMBER If it is possible, give an accurate number.
...
filing (n): PARTICLE (n)
FILL (v): To put into a container or a space to the maximum level or, if specified, to a given level, pressure, or quantity
film (n): LAYER (n)
filter (v): FILTER (TN)
...
flatness (n): FLAT (adj)
flatten (v): FLAT (adj)
flaw (n): DAMAGE (n); DEFECTIVE (adj) If it is possible, be accurate.
flex (v): BEND (v)
...
FLUSH (v): To remove something or to operate with a flow of liquid
focus (v): FOCUS (TN)
fold (n): FOLD (v)
FOLD (v): To double over or to cause to double over on itself
FOLLOW (v): To come after, to go after; | other meanings: OBEY (v)
following (adj): THESE (adj); FOLLOW (v)
FOR (prep): Function word that shows purpose, intent, time, result, or the object of an action; Used to introduce something chosen as a typical case
...
FREE (adj): That can move easily; Do not use compound adjectives with free, for example, lintfree, dustfree, unless they are technical nouns.
free from (adj): NO (adj)
free (v): RELEASE (v)
FREELY (adv): That can move easily
FREEZE (v): To go or cause to go to a temperature below the freezing point of a liquid (usually of water)
...
generous (adj): LARGE (adj); THICK (adj) If it is possible, be accurate.
generously (adv): LARGE (adj); THICK (adj) If it is possible, be accurate.
...
halve (v): HALF (TN)
hamper (v): PREVENT (v)
handle (v): MOVE (v); TOUCH (v); USE (v); CAREFUL (adj) This word can be part of a safety sign (rule 8.6).
...
hazard (n): DANGEROUS (adj) “hazard” can be part of safety regulations.
hazardous (adj): DANGEROUS (adj) “hazardous” can be part of safety regulations.
hazy (adj): HAZE (TN)
HEAD (n): The top of something
head (v): POINT (v)
HEAR (v): To know by sound in the ear
...
IDENTIFY (v): 1. To use a specified code or marking to supply with an identity; 2. To show an identity | other meanings: FIND (v)
idle (v): IDLE (TN)
...
INSTALL (v): To attach an item in or to a second item
...
INTERCHANGE (v): To put or use each of two things in the place of the other without change
INTERCHANGE- ABLE (adj): That you can interchange
...
interference (n): HIT (v); CATCH (v); TOUCH (v); This word can be a technical noun or part of a technical noun.
...
IT (pron): 1. That refers to a thing that was previously mentioned; 2. That refers to an explicit or implicit state of affairs or circumstances
...
later (adv): SUBSEQUENTLY (adv); WHEN (conj) If it is possible, give the condition or time.; AFTER (prep)
...
LIGHT (adj): That has a small mass, weight, or force | other meanings: THIN (adj); SMALL (adj)
light (v): COME ON
...
loop (v): LOOP (n)
LOOSE (adj): 1. On, in, but not attached; 2. Not tight | other meanings: TENSION (TN)
...
MANDATORY (adj): That which you must do, use, or obey; If you want to use this word in procedures, think about a necessary safety instruction.
...
mix (n): MIXTURE (n)
MIX (v): 1. To put together two or more materials to become one; 2. To become combined
...
MULTIPLY (v): To use multiplication to get a result | other meanings: INCREASE (v)
...
OPEN (v): 1. To move or cause to move from the closed position; 2. To operate a circuit breaker to interrupt an electrical circuit
...
operational (adj): SERVICEABLE (adj); OPERATE (v); This word can be part of a technical noun.
opportunity (n): If it is possible, be accurate.
...
overlap (v): OVERLAP (n)
OVERRIDE (v): To prevent the automatic operation of a part or system
...
PART (n): 1. A constituent of an object, machine, component, assembly, or equipment; 2. A piece or section of a whole
part (v): DISCONNECT (v)
...
people (n): PERSON (n); PERSONNEL (n) To select the correct alternative, refer to the approved meanings of PERSON (n) and PERSONNEL (n).
per (prep): FOR EACH; REFER (v)
perforated (adj): HOLE (n)
perform (v): DO (v); You can use a more accurate verb.; MEASURE (v)
PERFORMANCE (n): The ability of a part, a mechanism, or system to do its necessary function when you compare it with a standard or specification | other meanings: DO (v)
...
POINT (v): 1. To show the position or direction of; 2. To turn something in a specified direction
...
process (n): PROCEDURE (n); This word is a technical noun when it means a sequence of changes that occur and cause a result.
process (v): DO (v) THE … PROCEDURE (n)
produce (v): CAUSE (v); GIVE (v); MAKE (v); SUPPLY (v)
product (n): Be accurate. If it is possible, use the name of the product.
profile (n): CONTOUR (n)
...
propagation (n): INCREASE (v); If it is possible, give the dimensions or limits.
proper (adj): CORRECT (adj)
properly (adv): CORRECTLY (adv)
PROPERTY (n): A characteristic or attribute of an object
PROPORTION (n): The ratio of something to something else | other meanings: RELATION (n)
...
purge (v): REMOVE (v)
purify (v): CLEAN (v)
PUSH (v): 1.To apply a force to something to move it away from the source of the force; 2.To move with a force against something Use this word together with a preposition or an adverb to show direction.
...
READ (v): To come to know information with the eyes or electronically
...
rectify (v): CORRECT (v)
recur (v): OCCUR (v)
RECYCLE (v): To put a used material through a process to make it possible to use it or its components again | other meanings: CYCLE (n)
reduce (v): DECREASE (v)
...
reuse (v): USE (v)
reveal (v): SHOW (v)
reverse (adj): OPPOSITE (adj); This word is part of a technical noun when it refers to rearward thrust.
...
SAFETY (v): 1. To prevent accidental operation; 2. To make sure that something does not become loose
...
SHORT (adj): That has small length or duration; If it is possible, be accurate.
shorten (v): DECREASE (v)
should (v): MUST (v); IF (conj)
SHOW (v): 1. To cause to be seen; 2. To be in view or come into view
shut down (v): STOP (v)
...
SIMULATE (v): To make a condition that is the same as one that can occur in operation
...
SOAK (v): 1. To put something into a liquid and keep it there until it is fully wet or soft; 2.To stay in liquid until fully wet or soft.
soapy (adj): SOAP (TN)
...
soon (adv): TIME (n); If it is possible, give the time.
...
THUS (adv): For that reason | other meanings: FOLLOW (v)
tie (v): ATTACH (v)
TIGHT (adj): Not free | other meanings: SEAL (v); TENSION (TN)
...
TOGETHER (adv): In one group or position; | other meanings: AT THE SAME TIME
...
undertake (v): DO (v) You can use a more accurate verb.; START (v)
undo (v): LOOSEN (v)
...
UNSATISFAC- TORILY (adv): In an unsatisfactory manner
UNSATISFAC- TORY (adj): Not satisfactory
...
WAIT (v): To stop doing something while another thing occurs.
...
weakness (n): WEAK (adj)
WEAR (v): To become damaged by friction | other meanings: USE (v); PUT ON (v)
...
WILL (v): Auxiliary modal verb that shows simple future tense
