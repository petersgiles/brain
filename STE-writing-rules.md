# ASD-STE100 Simplified Technical English — Writing Rules (Part 1, condensed)

Source: ASD-STE100 Simplified Technical English, Issue 9 (2025-01-15), (c) ASD.
This file is a condensed extract of Part 1 (writing rules, sections 1-9) for AI/model
context use. Legal/administrative front matter, table of contents, and change history
removed; page-furniture (headers/footers/page numbers) stripped. Wording of the rules
themselves is otherwise unchanged. For the controlled-vocabulary dictionary, see
STE-dictionary.md in this folder.
...
ASD<br> Agent ( # Subject )<br>Passive voice : The main gear leg is held by the side stay.<br>! eee<br>Active voice The side stay i holds | : the main gear leg. :<br>Subject ( = Agent )<br> ##### <u>Method 4</u> 
...
ASD<br> One day I will find the<br>right words, and they<br>all will be simple.<br>Jack Kerouac<br>-<br>qin qpinapanddninan<br>————————_toteth ani }<br> 