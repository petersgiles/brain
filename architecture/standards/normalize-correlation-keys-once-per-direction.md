---
name: normalize-correlation-keys-once-per-direction
type: standard
description: Pick one place a shared ID gets normalized to its internal canonical form, and one place it gets re-decorated for external display.
---
...
place it gets normalized to its canonical internal form on the way in, and
